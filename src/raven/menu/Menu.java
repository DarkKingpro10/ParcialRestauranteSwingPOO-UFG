...
public class Menu extends JPanel {
    ...
    private final String headerName = "¡Bienvenido Admin!";
    ...
    private void init() {
        ...
        // Ruta del icono
        String iconPath = "/raven/icon/png/logo.png";
        ...
        Image image = originalIcon.getImage(); // Obtiene la imagen original
        Image resizedImage = image.getScaledInstance(width, height, Image.SCALE_SMOOTH); // Redimensiona la imagen
        ImageIcon resizedIcon = new ImageIcon(resizedImage); // Crea un nuevo ImageIcon
